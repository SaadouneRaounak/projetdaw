...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['email']) && isset($_POST['message'])) {
        ...
        $stmt = $connection->prepare("INSERT INTO messages (content, sender_id, email, created_at) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("siss", $message, $usersIdentification, $email, $currentDate);
        if ($stmt->execute()) {
